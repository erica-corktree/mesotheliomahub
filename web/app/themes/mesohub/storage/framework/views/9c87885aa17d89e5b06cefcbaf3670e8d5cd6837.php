    ...
    <div class="Container">
      ...
      <?php if(get_the_post_thumbnail_url()): ?>
        <picture class="Illustration">
          ...
          <img
            class="PageHeader__bg__img"
            srcset="<?php echo e(get_the_post_thumbnail_url(null, 'medium')); ?>"
            alt=""
      ...
      <?php else: ?>
        <?php if ($__env->exists("partials.svgs.illustrations.{$header_svg_name}")) echo $__env->make("partials.svgs.illustrations.{$header_svg_name}", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php endif; ?>
    </div>
  </header>

  <div class="Container Container--events">
    <?php while($events->have_posts()): ?> <?php $events->the_post() ?>
      <article class="Card Card--event">
        <div class="Card__event-icon">
          <div class="Card__month"><?php echo e(date('F', strtotime(get_field('event_date')))); ?></div>
          <div class="Card__day"><?php echo e(date('d', strtotime(get_field('event_date')))); ?></div>
        ...
        <div class="Card__event-content">
          <header class="Card__header">
            <h2 class="Card__heading"><?php echo get_the_title(); ?></h2>

            <time><?php echo e(get_field('event_date')); ?></time>
          </header>

          <p><?php echo e(__('Location')); ?>: <?php echo e(get_field('event_location')); ?></p>

          <a
            class="Button Button--small Button--primary"
            href="<?php echo e(get_field('event_url')); ?>"
            target="_blank"
          ><?php echo e(__('Learn More', 'sage')); ?></a>
        </div>
      </article>
    <?php endwhile; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/mesotheliomahub_583/public/current/web/app/themes/mesohub/resources/views/template-events-page.blade.php ENDPATH**/ ?>