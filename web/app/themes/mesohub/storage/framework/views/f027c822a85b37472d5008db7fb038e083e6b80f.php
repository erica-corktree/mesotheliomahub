    ...
    <div class="Hero Hero--guide">
      <div class="Container Container--hero-content">
        <div class="Hero__content">
          <h1 class="Hero__title" style="padding-top:0px"><?php echo e($banner->title); ?></h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/mesotheliomahub_583/public/current/web/app/themes/mesohub/resources/views/template-guide-page.blade.php ENDPATH**/ ?>