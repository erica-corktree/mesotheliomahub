<footer class="Footer">
  <div class="Container">
    <div class="Footer__col Footer__col--left">
      ...
      <p class="Footer__copyright">{!! do_shortcode(get_field('site_footer_copyright', 'option')) !!}</p>
    ...
    <p class="Footer__modified">{{ __('Last Modified', 'sage') }}: <time>{{ get_the_modified_date(null, get_the_ID()) }}</time>, {{ __('Created', 'sage') }}: <time>{{ get_the_date(null, get_the_ID()) }}</time></p>
  </div>
</footer>
